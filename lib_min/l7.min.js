...
Math.min(this.viewportWidth||this.width,this.width);this.viewportHeight=Math.min(this.viewportHeight||this.height,this.height);this.viewportAnchorX=this.viewportAnchor&&this.viewportAnchor.x||0;this.viewportAnchorY=this.viewportAnchor&&this.viewportAnchor.y||0;delete this.viewportAnchor;this._hitManager=new L7.HitManager};L7.Board.prototype={actorsOnTeam:function(a){return this.actors.filter(function(b){return b.team===a})},tilesTagged:function(a){return this.tiles.filter(function(b){return b.tag===
a})},getAnimationTargets:function(a){return"tiles"===a?this.tiles:"board"===a?[this]:_.isArray(a)?a:this.tiles},destroy:function(){},_clamp:function(a,b,c){return a<b?b:a>=c?c:a},_tileToPixels:function(a){return(this.tileSize+this.borderWidth)*a},scrollCenterOn:function(a){var b=this._tileToPixels(a.x)+this.tileSize/2,a=this._tileToPixels(a.y)+this.tileSize/2;this.viewport.centerOn(b,a)},scrollY:function(a){this.viewport&&this.viewport.scrollY(this._tileToPixels(a))},scrollX:function(a){this.viewport&&
this.viewport.scrollX(this._tileToPixels(a))},scrollXY:function(a,b){this.scrollX(a);this.scrollY(b)},column:function(a){0>a&&(a=this.width+a);for(var b=[],c=0;c<this.height;++c)b.push(this.tileAt(L7.p(a,c)));return b},row:function(a){var b=[];_.each(arguments,function(a){0>a&&(a=this.height+a);for(var d=0;d<this.width;++d)b.push(this.tileAt(L7.p(d,a)))},this);return b},rect:function(a,b,c,d){for(var f=[],g=b;g<b+d;++g)for(var h=a;h<a+c;++h)f.push(this.tileAt(h,g));return f},query:function(a){var b=
[];this.tiles.forEach(function(c){a(c)&&b.push(c)});return b},tileAt:function(a,b){var c=_.isObject(a)?a.x:a,d=_.isNumber(b)?b:a.y;return 0>d||d>=this.height||0>c||c>=this.width?null:this.tiles[d*this.width+c]},tileAtPixels:function(a,b){var c=_.isObject(a)?a.x:a,d=_.isNumber(b)?b:a.y;return this.tileAt(Math.floor(c/(this.tileSize+this.borderWidth)),Math.floor(d/(this.tileSize+this.borderWidth)))},pixelsForTile:function(a){return L7.p(this._tileToPixels(a.x),this._tileToPixels(a.y))},tileTopInPixels:function(a){return this._tileToPixels(a.y)},
tileBottomInPixels:function(a){return this.tileTopInPixels(a)+this.tileSize},each:function(a,b){this.tiles.forEach(a,b)},_addPieces:function(a){a.forEach(function(a){var c=this.tileAt(a.position);c&&c.add(a)},this)},_removePieces:function(a){a.forEach(function(a){var c=this.tileAt(a.position);c&&c.remove(a)},this)},promote:function(a){a.pieces&&(this._removePieces(a.pieces),this._addPieces(a.pieces))},addActor:function(a){a.pieces&&this._addPieces(a.pieces);this.actors.push(a);a.board=this},addFreeActor:function(a){this.freeActors.push(a);
a.board=this},removeFreeActor:function(a){this.freeActors.remove(a);delete a.board},removeActor:function(a){a.pieces&&this._removePieces(a.pieces);this.actors.remove(a);delete a.board},addDaemon:function(a){this.daemons.push(a)},removeDaemon:function(a){this.daemons.remove(a)},isOutOfBounds:function(a){for(var b=0,c=a.pieces.length;b<c;++b){var d=a.pieces[b].position;if(0>d.x||0>d.y||d.x>=this.width||d.y>=this.height)return!0}return!1},_movePiece:function(a,b){var c=a.position,d=a.position.add(b);
(c=this.tileAt(c))&&c.remove(a);(c=this.tileAt(d))&&c.add(a);a.position=d},movePiece:function(a){this._movePiece(a.piece,a.delta||a.to.delta(a.from))},moveActor:function(a){a.actor.pieces.forEach(function(b){this._movePiece(b,a.delta||a.to.delta(a.from))},this);a.actor.onOutOfBounds&&this.isOutOfBounds(a.actor)&&a.actor.onOutOfBounds.call(a.actor)},update:function(a,b){this.actors.forEach(function(c){c.update(a,b)});this.freeActors.forEach(function(c){c.update(a,b)});this.daemons.forEach(function(c){c.update(a,
b,this)},this);this._hitManager.detectHits(this.tiles)},render:function(a,b,c,d){var c=c+(this.offsetX||0),d=d+(this.offsetY||0),f=this.borderWidth,a=this.tileSize,g=(0>d?Math.ceil:Math.floor)(d/(a+f)),h=-d%(a+f),i,u=Math.min(this._rows.length,Math.ceil((d+b.canvas.height)/(a+f))),l=(0>c?Math.ceil:Math.floor)(c/(a+f)),k=-c%(a+f),n,w=Math.min(this._rows[0].length,Math.ceil((c+b.canvas.width)/(a+f))),q,m,v,r=[];for(i=g;i<u;++i)if(0<=i){v=this._rows[i];for(n=l;n<w;++n)if(0<=n&&(q=v[n],m=q.getColor()))o=
q.getScale(),_.isNumber(o)||(o=1),1!==o&&(r.push(q),m=q.getColor(!0),o=1),m&&(this.borderFill&&(b.fillStyle=this.borderFill,b.fillRect((n-l)*(a+f)+k,(i-g)*(a+f)+h,a+2*f,f),b.fillRect((n-l)*(a+f)+k,(i-g)*(a+f)+h+a+f,a+2*f,f),b.fillRect((n-l)*(a+f)+k,(i-g)*(a+f)+h,f,a+2*f),b.fillRect((n-l)*(a+f)+k+a+f,(i-g)*(a+f)+h,f,a+2*f)),b.fillStyle=m,m=Math.round(a*o),o=a/2-m/2,b.fillRect((n-l)*(a+f)+f+o+k,(i-g)*(a+f)+f+o+h,m,m))}r.sort(function(a,c){return a.scale-c.scale});for(i=0;i<r.length;++i){q=r[i];var o=
q.getScale();if(m=q.getColor())b.fillStyle=m,m=Math.round(a*o),o=a/2-m/2,b.fillRect((q.x-l)*(a+f)+f+o+k,(q.y-g)*(a+f)+f+o+h,m,m)}for(i=0;i<this.freeActors.length;++i)if(f=this.freeActors[i],m=L7.Color.toCssString(f.color))b.fillStyle=m,b.fillRect(f.position.x-c,f.position.y-d,a,a)}}})();
...
if(this.isRgbString(c)){for(var d=c.indexOf("("),f=[],c=c.substring(d+1).split(","),d=0,g=c.length;d<g;++d)f.push(parseFloat(c[d]));3===f.length&&f.push(1);return f}},fromArrayToHex:function(a,b){for(var f="#",g=b&&b.includeAlpha&&4===a.length?4:3,h=0;h<g;++h){var i=a[h].toString(16);2>i.length&&(i="0"+i);f+=i}return f.toUpperCase()},composite:function(a){for(var b=this.toArray(arguments[0]).slice(0),f=1;f<arguments.length;++f){var g=b,h=this.toArray(arguments[f]),i=h[3],u=g[3],l=1-i,k=void 0,n=void 0;
for(k=0,n=g.length-1;k<n;++k)g[k]=Math.round(h[k]*i+g[k]*u*l)}return b}};var b={aliceblue:"#F0F8FF",antiquewhite:"#FAEBD7",aqua:"#00FFFF",aquamarine:"#7FFFD4",azure:"#F0FFFF",beige:"#F5F5DC",bisque:"#FFE4C4",black:"#000000",blanchedalmond:"#FFEBCD",blue:"#0000FF",blueviolet:"#8A2BE2",brown:"#A52A2A",burlywood:"#DEB887",cadetblue:"#5F9EA0",chartreuse:"#7FFF00",chocolate:"#D2691E",coral:"#FF7F50",cornflowerblue:"#6495ED",cornsilk:"#FFF8DC",crimson:"#DC143C",cyan:"#00FFFF",darkblue:"#00008B",darkcyan:"#008B8B",
...
(function(){function a(){return L7.rand(-1,1,!0)}var b=0;L7.ParticleSystem=function(a){_.extend(this,a);this._particles=[];this.id=b++;for(a=0;a<this.totalParticles;++a)this._particles.push({});this._particleCount=this._particleIndex=this._emitCounter=this._elapsed=0;this.active=this.active||!1};L7.ParticleSystem.prototype={_isFull:function(){return this._particleCount===this.totalParticles},_initParticle:function(b){b.x=this.centerOfGravity.x+this.posVar.x*a()|0;b.y=this.centerOfGravity.y+this.posVar.y*
a()|0;var d;d=this.angle+this.angleVar*a();d=(d||0)*Math.PI/180;d=L7.p(Math.cos(d),Math.sin(d));var f=this.speed+this.speedVar*a();d=d.multiply(f);b.dir=d;b.radialAccel=this.radialAccel+this.radialAccelVar*a();b.tangentialAccel=this.tangentialAccel+this.tangentialAccelVar*a();d=this.life+this.lifeVar*a();b.life=Math.max(0,d);d=[this.startColor[0]+this.startColorVar[0]*a(),this.startColor[1]+this.startColorVar[1]*a(),this.startColor[2]+this.startColorVar[2]*a(),this.startColor[3]+this.startColorVar[3]*
a()];f=[this.endColor[0]*this.endColorVar[0]*a(),this.endColor[1]*this.endColorVar[1]*a(),this.endColor[2]*this.endColorVar[2]*a(),this.endColor[3]*this.endColorVar[3]*a()];b.color=d;b.deltaColor=[(f[0]-d[0])/b.life,(f[1]-d[1])/b.life,(f[2]-d[2])/b.life,(f[3]-d[3])/b.life];b.startPos=this.position},_addParticle:function(){if(this._isFull())return!1;this._initParticle(this._particles[this._particleCount]);++this._particleCount;return!0},update:function(a,b,f){if(this.active&&this.emissionRate){b=1/
this.emissionRate;for(this._emitCounter+=a;!this._isFull()&&this._emitCounter>b;)this._addParticle(),this._emitCounter-=b;this._elapsed+=a;this._elapsed>=this.duration&&this._stopSystem()}for(this._particleIndex=0;this._particleIndex<this._particleCount;)this._updateParticle(this._particles[this._particleIndex],a,this._particleIndex);this._updateBoard(f)},_updateParticle:function(a,b,f){if(0<a.life){var f=L7.p(),g=L7.p(),h=L7.p();0!==a.x&&0!==a.y&&(g=L7.p(a.x,a.y).normalize());h=g.clone();g.x*=a.radialAccel;
g.y*=a.radialAccel;var i=h.x;h.x=-h.y;h.y=i;h.x*=a.tangentialAccel;h.y*=a.tangentialAccel;f.x=g.x+h.x+this.gravity.x;f.y=g.y+h.y+this.gravity.y;f.x*=b;f.y*=b;f.x=a.dir.x*b;f.y=a.dir.y*b;a.x+=Math.floor(f.x);a.y+=Math.floor(f.y);a.color[0]+=a.deltaColor[0]*b;a.color[1]+=a.deltaColor[1]*b;a.color[2]+=a.deltaColor[2]*b;a.color[3]+=a.deltaColor[3]*b;a.life-=b;++this._particleIndex}else a=this._particles[f],this._particles[f]=this._particles[this._particleCount-1],this._particles[this._particleCount-1]=
a,--this._particleCount},_updateBoard:function(a){a.actorsOnTeam("particle-"+this.id).forEach(function(b){a.removeActor(b)});for(var b=0;b<this._particleCount;++b){var f=this._particles[b],g=a.tileAt(f.x,f.y);if(g){var h=g.inhabitants&&g.inhabitants.length&&g.inhabitants.last.owner;h?h.color=L7.Color.composite(h.color,f.color):a.addActor(new L7.Actor({position:g.position,color:f.color.slice(0),team:"particle-"+this.id}))}}}}})();
(function(){function a(b,c,d){if(b===c)return 0!==b||1/b==1/c;if(null==b||null==c)return b===c;b._chain&&(b=b._wrapped);c._chain&&(c=c._wrapped);if(b.isEqual&&e.isFunction(b.isEqual))return b.isEqual(c);if(c.isEqual&&e.isFunction(c.isEqual))return c.isEqual(b);var f=l.call(b);if(f!=l.call(c))return!1;switch(f){case "[object String]":return b==""+c;case "[object Number]":return b!=+b?c!=+c:0==b?1/b==1/c:b==+c;case "[object Date]":case "[object Boolean]":return+b==+c;case "[object RegExp]":return b.source==
c.source&&b.global==c.global&&b.multiline==c.multiline&&b.ignoreCase==c.ignoreCase}if("object"!=typeof b||"object"!=typeof c)return!1;for(var g=d.length;g--;)if(d[g]==b)return!0;d.push(b);var g=0,h=!0;if("[object Array]"==f){if(g=b.length,h=g==c.length)for(;g--&&(h=g in b==g in c&&a(b[g],c[g],d)););}else{if("constructor"in b!="constructor"in c||b.constructor!=c.constructor)return!1;for(var t in b)if(k.call(b,t)&&(g++,!(h=k.call(c,t)&&a(b[t],c[t],d))))break;if(h){for(t in c)if(k.call(c,t)&&!g--)break;
h=!g}}d.pop();return h}var b=this,c=b._,d={},f=Array.prototype,g=Object.prototype,h=f.slice,i=f.concat,u=f.unshift,l=g.toString,k=g.hasOwnProperty,n=f.forEach,w=f.map,q=f.reduce,m=f.reduceRight,v=f.filter,r=f.every,o=f.some,z=f.indexOf,C=f.lastIndexOf,g=Array.isArray,F=Object.keys,A=Function.prototype.bind,e=function(a){return new s(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=e),exports._=e):"function"===typeof define&&define.amd?define("underscore",
function(){return e}):b._=e;e.VERSION="1.2.3";var p=e.each=e.forEach=function(a,b,c){if(null!=a)if(n&&a.forEach===n)a.forEach(b,c);else if(a.length===+a.length)for(var e=0,f=a.length;e<f&&!(e in a&&b.call(c,a[e],e,a)===d);e++);else for(e in a)if(k.call(a,e)&&b.call(c,a[e],e,a)===d)break};e.map=function(a,b,c){var d=[];if(null==a)return d;if(w&&a.map===w)return a.map(b,c);p(a,function(a,j,e){d[d.length]=b.call(c,a,j,e)});return d};e.reduce=e.foldl=e.inject=function(a,b,c,d){var f=2<arguments.length;
null==a&&(a=[]);if(q&&a.reduce===q)return d&&(b=e.bind(b,d)),f?a.reduce(b,c):a.reduce(b);p(a,function(a,j,e){f?c=b.call(d,c,a,j,e):(c=a,f=!0)});if(!f)throw new TypeError("Reduce of empty array with no initial value");return c};e.reduceRight=e.foldr=function(a,b,c,d){var f=2<arguments.length;null==a&&(a=[]);if(m&&a.reduceRight===m)return d&&(b=e.bind(b,d)),f?a.reduceRight(b,c):a.reduceRight(b);var g=e.toArray(a).reverse();d&&!f&&(b=e.bind(b,d));return f?e.reduce(g,b,c,d):e.reduce(g,b)};e.find=e.detect=
function(a,b,c){var d;D(a,function(a,j,e){if(b.call(c,a,j,e))return d=a,!0});return d};e.filter=e.select=function(a,b,c){var d=[];if(null==a)return d;if(v&&a.filter===v)return a.filter(b,c);p(a,function(a,j,e){b.call(c,a,j,e)&&(d[d.length]=a)});return d};e.reject=function(a,b,c){var d=[];if(null==a)return d;p(a,function(a,j,e){b.call(c,a,j,e)||(d[d.length]=a)});return d};e.every=e.all=function(a,b,c){var e=!0;if(null==a)return e;if(r&&a.every===r)return a.every(b,c);p(a,function(a,j,f){if(!(e=e&&
b.call(c,a,j,f)))return d});return e};var D=e.some=e.any=function(a,b,c){b||(b=e.identity);var f=!1;if(null==a)return f;if(o&&a.some===o)return a.some(b,c);p(a,function(a,j,e){if(f||(f=b.call(c,a,j,e)))return d});return!!f};e.include=e.contains=function(a,b){return null==a?!1:z&&a.indexOf===z?-1!=a.indexOf(b):D(a,function(a){return a===b})};e.invoke=function(a,b){var c=h.call(arguments,2);return e.map(a,function(a){return(b.call?b||a:a[b]).apply(a,c)})};e.pluck=function(a,b){return e.map(a,function(a){return a[b]})};
e.max=function(a,b,c){if(!b&&e.isArray(a))return Math.max.apply(Math,a);if(!b&&e.isEmpty(a))return-Infinity;var d={computed:-Infinity};p(a,function(a,j,e){j=b?b.call(c,a,j,e):a;j>=d.computed&&(d={value:a,computed:j})});return d.value};e.min=function(a,b,c){if(!b&&e.isArray(a))return Math.min.apply(Math,a);if(!b&&e.isEmpty(a))return Infinity;var d={computed:Infinity};p(a,function(a,j,e){j=b?b.call(c,a,j,e):a;j<d.computed&&(d={value:a,computed:j})});return d.value};e.shuffle=function(a){var b=[],c;
p(a,function(a,d){0==d?b[0]=a:(c=Math.floor(Math.random()*(d+1)),b[d]=b[c],b[c]=a)});return b};e.sortBy=function(a,b,c){return e.pluck(e.map(a,function(a,d,j){return{value:a,criteria:b.call(c,a,d,j)}}).sort(function(a,b){var c=a.criteria,d=b.criteria;return c<d?-1:c>d?1:0}),"value")};e.groupBy=function(a,b){var c={},d=e.isFunction(b)?b:function(a){return a[b]};p(a,function(a,b){var j=d(a,b);(c[j]||(c[j]=[])).push(a)});return c};e.sortedIndex=function(a,b,c){c||(c=e.identity);for(var d=0,f=a.length;d<
...
b?c:-1;if(z&&a.indexOf===z)return a.indexOf(b);for(c=0,d=a.length;c<d;c++)if(c in a&&a[c]===b)return c;return-1};e.lastIndexOf=function(a,b){if(null==a)return-1;if(C&&a.lastIndexOf===C)return a.lastIndexOf(b);for(var c=a.length;c--;)if(c in a&&a[c]===b)return c;return-1};e.range=function(a,b,c){1>=arguments.length&&(b=a||0,a=0);for(var c=arguments[2]||1,d=Math.max(Math.ceil((b-a)/c),0),e=0,f=Array(d);e<d;)f[e++]=a,a+=c;return f};var E=function(){};e.bind=function(a,b){var c,d;if(a.bind===A&&A)return A.apply(a,
h.call(arguments,1));if(!e.isFunction(a))throw new TypeError;d=h.call(arguments,2);return c=function(){if(!(this instanceof c))return a.apply(b,d.concat(h.call(arguments)));E.prototype=a.prototype;var e=new E,f=a.apply(e,d.concat(h.call(arguments)));return Object(f)===f?f:e}};e.bindAll=function(a){var b=h.call(arguments,1);0==b.length&&(b=e.functions(a));p(b,function(b){a[b]=e.bind(a[b],a)});return a};e.memoize=function(a,b){var c={};b||(b=e.identity);return function(){var d=b.apply(this,arguments);
return k.call(c,d)?c[d]:c[d]=a.apply(this,arguments)}};e.delay=function(a,b){var c=h.call(arguments,2);return setTimeout(function(){return a.apply(a,c)},b)};e.defer=function(a){return e.delay.apply(e,[a,1].concat(h.call(arguments,1)))};e.throttle=function(a,b){var c,d,f,g,h,i=e.debounce(function(){h=g=!1},b);return function(){c=this;d=arguments;f||(f=setTimeout(function(){f=null;h&&a.apply(c,d);i()},b));g?h=!0:a.apply(c,d);i();g=!0}};e.debounce=function(a,b){var c;return function(){var d=this,e=arguments;
clearTimeout(c);c=setTimeout(function(){c=null;a.apply(d,e)},b)}};e.once=function(a){var b=!1,c;return function(){if(b)return c;b=!0;return c=a.apply(this,arguments)}};e.wrap=function(a,b){return function(){var c=i.apply([a],arguments);return b.apply(this,c)}};e.compose=function(){var a=arguments;return function(){for(var b=arguments,c=a.length-1;0<=c;c--)b=[a[c].apply(this,b)];return b[0]}};e.after=function(a,b){return 0>=a?b():function(){if(1>--a)return b.apply(this,arguments)}};e.keys=F||function(a){if(a!==
...
"\\r").replace(/\n/g,"\\n").replace(/\t/g,"\\t")+"');}return __p.join('');",d=new Function("obj","_",c);return b?d(b,e):function(a){return d.call(this,a,e)}};var s=function(a){this._wrapped=a};e.prototype=s.prototype;var B=function(a,b){return b?e(a).chain():a},G=function(a,b){s.prototype[a]=function(){var a=h.call(arguments);u.call(a,this._wrapped);return B(b.apply(e,a),this._chain)}};e.mixin(e);p("pop,push,reverse,shift,sort,splice,unshift".split(","),function(a){var b=f[a];s.prototype[a]=function(){b.apply(this._wrapped,
arguments);return B(this._wrapped,this._chain)}});p(["concat","join","slice"],function(a){var b=f[a];s.prototype[a]=function(){return B(b.apply(this._wrapped,arguments),this._chain)}});s.prototype.chain=function(){this._chain=!0;return this};s.prototype.value=function(){return this._wrapped}}).call(this);
...
enumerable:!1})})();(function(){L7.rand=function(a,b,c){_.isUndefined(c)&&(c=!1);var d=_.isNumber(b)?a:0,a=_.isNumber(b)?b:a,b=Math.random()*(a-d)+d;return d===(d|0)&&a===(a|0)&&!c?Math.floor(b):b}})();
