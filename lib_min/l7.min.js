...
d?Math.ceil:Math.floor)(d/(a+e)),g=-d%(a+e),h,o=Math.min(this._rows.length,Math.ceil((d+b.canvas.height)/(a+e))),k=(0>c?Math.ceil:Math.floor)(c/(a+e)),l=-c%(a+e),j,s=Math.min(this._rows[0].length,Math.ceil((c+b.canvas.width)/(a+e))),m,i,r,q=[];for(h=f;h<o;++h)if(0<=h){r=this._rows[h];for(j=k;j<s;++j)if(0<=j&&(m=r[j],i=m.getColor())){var p=m.getScale();_.isNumber(p)||(p=1);var n=m.getOffset();if(1!==p||n&&(n.x||n.y))q.push(m),i=m.getColor(!0),p=1;i&&(this.borderFill&&(b.fillStyle=this.borderFill,b.fillRect((j-
k)*(a+e)+l,(h-f)*(a+e)+g,a+2*e,e),b.fillRect((j-k)*(a+e)+l,(h-f)*(a+e)+g+a+e,a+2*e,e),b.fillRect((j-k)*(a+e)+l,(h-f)*(a+e)+g,e,a+2*e),b.fillRect((j-k)*(a+e)+l+a+e,(h-f)*(a+e)+g,e,a+2*e)),b.fillStyle=i,i=Math.round(a*p),n=a/2-i/2,b.fillRect((j-k)*(a+e)+e+n+l,(h-f)*(a+e)+e+n+g,i,i))}}q.sort(function(a,c){return a.scale-c.scale});for(h=0;h<q.length;++h)if(m=q[h],p=m.getScale(),i=m.getColor())b.fillStyle=i,i=a*p|0,n=m.getOffset(),o=a*n.x,j=a*n.y,n=a/2-i/2,b.fillRect((m.x-k)*(a+e)+e+n+l+o,(m.y-f)*(a+e)+
e+n+g+j,i,i);for(h=0;h<this.freeActors.length;++h)if(e=this.freeActors[h],i=L7.Color.toCssString(e.color))b.fillStyle=i,b.fillRect(e.position.x-c,e.position.y-d,a,a);this.angle&&b.restore()}}})();
