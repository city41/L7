...
b),L7.Color.toCssString(b)},getColorOld:function(){var a;if(0===this.inhabitants.length||!this.inhabitants[this.inhabitants.length-1].color)a=this.color;else if(a=this.inhabitants[this.inhabitants.length-1],L7.Color.isOpaque(a.color)||!this.color)a=a.color;else{var b=this.color.slice(0);a=L7.Color.composite(b,a.color)}this.overlayColor&&(a=!a||L7.Color.isOpaque(this.overlayColor)?this.overlayColor:L7.Color.composite(a.slice(0),this.overlayColor));if(a)return L7.Color.toCssString(a)},getScale:function(){return 0===
...
this.viewport=new L7.Viewport(this);this.board&&(this.board.viewport=this.viewport);this.container=this.container||document.body;this.canvas=this._createCanvas();this.delays=[];var c=this;L7.global.addEventListener("blur",function(){delete c._lastTimestamp})};L7.Game.prototype={_createCanvas:function(){var a=document.createElement("canvas");a.width=this.viewport.width;a.height=this.viewport.height;a.style.imageRendering="-webkit-optimize-contrast";this.container.appendChild(a);return a},go:function(){delete this._lastTimestamp;
this._doFrame(Date.now())},after:function(a,c){this.delays.add({remaining:a,handler:c})},replaceBoard:function(a){this.board&&this.board.destroy&&this.board.destroy();this.board=a;this.board.viewport=this.viewport;this.viewport.reset()},_updateDelays:function(a){var c=[];this.delays.forEach(function(d){d.remaining-=a;0>=d.remaining&&(d.handler.call(d.scope,this),c.push(d))},this);c.forEach(function(a){this.delays.remove(a)},this)},_pause:function(){var a=this.canvas.getContext("2d");a.save();a.fillStyle=
"rgba(255,255,255,0.5)";a.fillRect(0,0,this.canvas.width,this.canvas.height);a.restore()},_doFrame:function(b){var c=b-(this._lastTimestamp||b);this._lastTimestamp=b;for(var d=c;0<d;){var e=Math.min(a,d);this._updateDelays(e);this.board.update(e,b);d-=e}d=this.canvas.getContext("2d");d.clearRect(0,0,this.canvas.width,this.canvas.height);this.board.render(c,d,this.viewport.anchorX,this.viewport.anchorY,b);this.paused||requestAnimationFrame(this._doFrame)}};Object.defineProperty(L7.Game.prototype,"paused",
{get:function(){return this._paused},set:function(a){var c=this._paused;this._paused=a;c!==a&&(a?this._pause():this.go())}})})();
...
a.x:a||0),this.y+("number"===typeof a.y?a.y:b||0))},subtract:function(a,b){x="number"===typeof a.x?a.x:a||0;y="number"===typeof a.y?a.y:b||0;return L7.p(this.x-x,this.y-y)},negate:function(){return L7.p(-this.x,-this.y)},multiply:function(a){return L7.p(this.x*a,this.y*a)},round:function(){return L7.pr(this.x,this.y)},dot:function(a){return this.x*a.x+this.y*a.y},length:function(){return Math.sqrt(this.dot(this))},normalize:function(){return this.multiply(1/this.length())},distanceFrom:function(a){a=
this.delta(a);return Math.sqrt(a.dot(a))},toString:function(){return"["+this._a+","+this._b+"]"}};L7.Pair.prototype.delta=L7.Pair.prototype.subtract;Object.defineProperty(L7.Pair.prototype,"width",{get:function(){return this._a}});Object.defineProperty(L7.Pair.prototype,"height",{get:function(){return this._b}});Object.defineProperty(L7.Pair.prototype,"x",{get:function(){return this._a},set:function(a){this._a=a}});Object.defineProperty(L7.Pair.prototype,"y",{get:function(){return this._b},set:function(a){this._b=
a}});L7.s=function(a,b){return new L7.Pair(a,b)};L7.p=L7.s;L7.sr=function(a,b){return new L7.Pair(Math.round(a),Math.round(b))};L7.pr=L7.sr})();
...
a.removeActor(b)},this);this._addedActors=!1},reset:function(){this._particleIndex=this._particleCount=0},_isFull:function(){return this._particleCount===this.totalParticles},_initParticle:function(c){c.rx=this.position.x+this.posVar.x*a();c.ry=this.position.y+this.posVar.y*a();var b;b=this.angle+this.angleVar*a();b=(b||0)*Math.PI/180;b=L7.p(Math.cos(b),Math.sin(b));var e=this.speed+this.speedVar*a();b=b.multiply(e);c.dir=b;c.radialAccel=this.radialAccel+this.radialAccelVar*a();c.radialAccel&&(c.radialAccel=
0);c.tangentialAccel=this.tangentialAccel+this.tangentialAccelVar*a();c.tangentialAccel||(c.tangentialAccel=0);b=this.life+this.lifeVar*a();c.life=Math.max(0,b);b=[this.startColor[0]+this.startColorVar[0]*a(),this.startColor[1]+this.startColorVar[1]*a(),this.startColor[2]+this.startColorVar[2]*a(),this.startColor[3]+this.startColorVar[3]*a()];e=[this.endColor[0]*this.endColorVar[0]*a(),this.endColor[1]*this.endColorVar[1]*a(),this.endColor[2]*this.endColorVar[2]*a(),this.endColor[3]*this.endColorVar[3]*
a()];c.color=b;c.pieces[0].color=b;c.deltaColor=[(e[0]-b[0])/c.life,(e[1]-b[1])/c.life,(e[2]-b[2])/c.life,(e[3]-b[3])/c.life];_.isUndefined(this.startSize)?(c.size=1,c.deltaSize=0):(b=this.startSize+this.startSizeVar*a(),b=Math.max(0,b),c.size=b,_.isUndefined(this.endSize)?c.deltaSize=0:(e=this.endSize+this.endSizeVar*a(),c.deltaSize=(e-b)/c.life))},_addParticle:function(){if(this._isFull())return!1;this._initParticle(this._particles[this._particleCount]);++this._particleCount;return!0},update:function(a,
b,e){if(this.active){a/=1E3;if(this.emissionRate){b=1/this.emissionRate;for(this._emitCounter+=a;!this._isFull()&&this._emitCounter>b;)this._addParticle(),this._emitCounter-=b}this._elapsed+=a;this.active=this._elapsed<this.duration;for(this._particleIndex=0;this._particleIndex<this._particleCount;)this._updateParticle(this._particles[this._particleIndex],a,this._particleIndex);this._updateBoard(e)}},_updateParticle:function(a,b,e){if(0<a.life){var e=L7.p(),f=L7.p(),g=L7.p();if(a.position.x!==this.position.x||
a.position.y!==this.position.y)f=L7.p(a.rx,a.ry).normalize();g=f.clone();f.x*=a.radialAccel;f.y*=a.radialAccel;var h=g.x;g.x=-g.y;g.y=h;g.x*=a.tangentialAccel;g.y*=a.tangentialAccel;e.x=f.x+g.x+this.gravity.x;e.y=f.y+g.y+this.gravity.y;e.x*=b;e.y*=b;a.dir.x+=e.x;a.dir.y+=e.y;e.x=a.dir.x*b;e.y=a.dir.y*b;a.rx+=e.x;a.ry+=e.y;a.goTo(L7.pr(a.rx,a.ry));a.color[0]+=a.deltaColor[0]*b;a.color[1]+=a.deltaColor[1]*b;a.color[2]+=a.deltaColor[2]*b;a.color[3]+=a.deltaColor[3]*b;a.size+=a.deltaSize*b;a.size=Math.max(0,
a.size);a.pieces[0].scale=a.size;a.life-=b;++this._particleIndex}else a=this._particles[e],this._particles[e]=this._particles[this._particleCount-1],this._particles[this._particleCount-1]=a,--this._particleCount},_updateBoard:function(a){this._addedActors||(this._particles.forEach(function(b){a.addActor(b)}),this._addedActors=!0);for(var b=L7.p(-1,-1),e=this._particleCount;e<this._particles.length;++e)this._particles[e].goTo(b)}}})();
...
enumerable:!1})})();(function(){L7.rand=function(a,b,c){_.isUndefined(c)&&(c=!1);var d=_.isNumber(b)?a:0,a=_.isNumber(b)?b:a,b=Math.random()*(a-d)+d;return d===(d|0)&&a===(a|0)&&!c?Math.floor(b):b};L7.coin=function(){return 0===L7.rand(0,2)}})();
