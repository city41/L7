...
this.isOutOfBounds(a.actor)&&a.actor.onOutOfBounds.call(a.actor)},update:function(a,b){this.actors.forEach(function(d){d.update(a,b)});this.freeActors.forEach(function(d){d.update(a,b)});this.daemons.forEach(function(d){d.update(a,b,this)},this);this._hitManager.detectHits(this.tiles)},render:function(a,b,d,e){var f=this.borderWidth,a=this.tileSize,h=(0>e?Math.ceil:Math.floor)(e/(a+f)),j=-e%(a+f),k,u=Math.min(this._rows.length,Math.ceil((e+b.canvas.height)/(a+f))),n=(0>d?Math.ceil:Math.floor)(d/(a+
f)),l=-d%(a+f),q,w=Math.min(this._rows[0].length,Math.ceil((d+b.canvas.width)/(a+f))),r,m,v,s=[];for(k=h;k<u;++k)if(0<=k){v=this._rows[k];for(q=n;q<w;++q)0<=q&&(r=v[q],m=r.getColor(),o=r.getScale(),_.isNumber(o)||(o=1),0!==o&&m&&(1>=o?(this.borderFill&&(b.fillStyle=this.borderFill,b.fillRect((q-n)*(a+f)+l,(k-h)*(a+f)+j,a+2*f,a+2*f)),b.fillStyle=m,m=Math.round(a*o),o=a/2-m/2,b.fillRect((q-n)*(a+f)+f+o+l,(k-h)*(a+f)+f+o+j,m,m)):s.push(r)))}s.sort(function(a,b){return a.scale-b.scale});for(k=0;k<s.length;++k){debugger;
r=s[k];var o=r.getScale();if(m=r.getColor())b.fillStyle=m,m=Math.round(a*o),o=a/2-m/2,b.fillRect((r.x-n)*(a+f)+f+o+l,(r.y-h)*(a+f)+f+o+j,m,m)}for(k=0;k<this.freeActors.length;++k)if(f=this.freeActors[k],m=L7.Color.toCssString(f.color))b.fillStyle=m,b.fillRect(f.position.x-d,f.position.y-e,a,a)}}})();
...
has:function(a){return this.tag===a?!0:this.inhabitants.some(function(b){return b.team===a||b.owner&&b.owner.team===a})},hasOther:function(a,b){return this.tag===a?!0:this.inhabitants.some(function(d){return d.team===a||d.owner&&d.owner.team===a&&d.owner!==b})},getColor:function(){var a=[];this.color&&a.push(this.color);0<this.inhabitants.length&&this.inhabitants.last.color&&a.push(this.inhabitants.last.color);this.overlayColor&&a.push(this.overlayColor);if(0<a.length)return a=L7.Color.composite.apply(L7.Color,
a),L7.Color.toCssString(a)},getColorOld:function(){var a;if(0===this.inhabitants.length||!this.inhabitants[this.inhabitants.length-1].color)a=this.color;else if(a=this.inhabitants[this.inhabitants.length-1],L7.Color.isOpaque(a.color)||!this.color)a=a.color;else{var b=this.color.slice(0);a=L7.Color.composite(b,a.color)}this.overlayColor&&(a=!a||L7.Color.isOpaque(this.overlayColor)?this.overlayColor:L7.Color.composite(a.slice(0),this.overlayColor));if(a)return L7.Color.toCssString(a)},getScale:function(){return 0===
...
d=d.substring(e+1).split(","),e=0,h=d.length;e<h;++e)f.push(parseFloat(d[e]));3===f.length&&f.push(1);return f}},fromArrayToHex:function(a,b){for(var f="#",h=b&&b.includeAlpha&&4===a.length?4:3,j=0;j<h;++j){var k=a[j].toString(16);2>k.length&&(k="0"+k);f+=k}return f.toUpperCase()},composite:function(a){for(var b=this.toArray(arguments[0]).slice(0),f=1;f<arguments.length;++f){var h=b,j=this.toArray(arguments[f]),k=j[3],u=h[3],n=1-k,l=void 0,q=void 0;for(l=0,q=h.length-1;l<q;++l)h[l]=Math.round(j[l]*
...
(function(){L7.LevelLoader=function(a){_.extend(this,a);this.width=a.image.width;this.height=a.image.height};L7.LevelLoader.prototype={load:function(){for(var a=_.extend(this.boardConfig,{width:this.width,height:this.height}),b=new L7.Board(a),d={},a=this._getData(),e=0;e<a.length;e+=4){var f=this._extractColor(a,e),h=this.legend[f];if(h){var j=this._getPosition(e);if(h.hasOwnProperty("constructor")){var k=_.extend({},h.config||{},{position:j});_.isArray(h.constructor)||(h.constructor=[h.constructor]);
h.constructor.forEach(function(a){a=new a(k);d[f]=d[f]||[];d[f].push(a);b.addActor(a)})}h.tag&&(b.tileAt(j).tag=h.tag);h.color&&(b.tileAt(j).color=h.color)}}return{board:b,actors:d}},_getData:function(){var a=document.createElement("canvas");a.width=this.width;a.height=this.height;a=a.getContext("2d");a.drawImage(this.image,0,0);return a.getImageData(0,0,this.width,this.height).data},_extractColor:function(a,b){for(var d=[],e=b;e<b+3;++e)d.push(a[e]);return L7.Color.fromArrayToHex(d)},_getPosition:function(a){a=
...
(function(){function a(g,i,b){if(g===i)return 0!==g||1/g==1/i;if(null==g||null==i)return g===i;g._chain&&(g=g._wrapped);i._chain&&(i=i._wrapped);if(g.isEqual&&c.isFunction(g.isEqual))return g.isEqual(i);if(i.isEqual&&c.isFunction(i.isEqual))return i.isEqual(g);var A=n.call(g);if(A!=n.call(i))return!1;switch(A){case "[object String]":return g==""+i;case "[object Number]":return g!=+g?i!=+i:0==g?1/g==1/i:g==+i;case "[object Date]":case "[object Boolean]":return+g==+i;case "[object RegExp]":return g.source==
i.source&&g.global==i.global&&g.multiline==i.multiline&&g.ignoreCase==i.ignoreCase}if("object"!=typeof g||"object"!=typeof i)return!1;for(var d=b.length;d--;)if(b[d]==g)return!0;b.push(g);var d=0,e=!0;if("[object Array]"==A){if(d=g.length,e=d==i.length)for(;d--&&(e=d in g==d in i&&a(g[d],i[d],b)););}else{if("constructor"in g!="constructor"in i||g.constructor!=i.constructor)return!1;for(var f in g)if(l.call(g,f)&&(d++,!(e=l.call(i,f)&&a(g[f],i[f],b))))break;if(e){for(f in i)if(l.call(i,f)&&!d--)break;
e=!d}}b.pop();return e}var b=this,d=b._,e={},f=Array.prototype,h=Object.prototype,j=f.slice,k=f.concat,u=f.unshift,n=h.toString,l=h.hasOwnProperty,q=f.forEach,w=f.map,r=f.reduce,m=f.reduceRight,v=f.filter,s=f.every,o=f.some,z=f.indexOf,D=f.lastIndexOf,h=Array.isArray,H=Object.keys,B=Function.prototype.bind,c=function(a){return new t(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=c),exports._=c):"function"===typeof define&&define.amd?define("underscore",
function(){return c}):b._=c;c.VERSION="1.2.3";var p=c.each=c.forEach=function(a,i,b){if(null!=a)if(q&&a.forEach===q)a.forEach(i,b);else if(a.length===+a.length)for(var c=0,d=a.length;c<d&&!(c in a&&i.call(b,a[c],c,a)===e);c++);else for(c in a)if(l.call(a,c)&&i.call(b,a[c],c,a)===e)break};c.map=function(a,i,b){var c=[];if(null==a)return c;if(w&&a.map===w)return a.map(i,b);p(a,function(a,g,d){c[c.length]=i.call(b,a,g,d)});return c};c.reduce=c.foldl=c.inject=function(a,i,b,d){var e=2<arguments.length;
null==a&&(a=[]);if(r&&a.reduce===r)return d&&(i=c.bind(i,d)),e?a.reduce(i,b):a.reduce(i);p(a,function(a,g,c){e?b=i.call(d,b,a,g,c):(b=a,e=!0)});if(!e)throw new TypeError("Reduce of empty array with no initial value");return b};c.reduceRight=c.foldr=function(a,i,b,d){var e=2<arguments.length;null==a&&(a=[]);if(m&&a.reduceRight===m)return d&&(i=c.bind(i,d)),e?a.reduceRight(i,b):a.reduceRight(i);var f=c.toArray(a).reverse();d&&!e&&(i=c.bind(i,d));return e?c.reduce(f,i,b,d):c.reduce(f,i)};c.find=c.detect=
function(a,i,b){var c;F(a,function(a,g,d){if(i.call(b,a,g,d))return c=a,!0});return c};c.filter=c.select=function(a,b,c){var d=[];if(null==a)return d;if(v&&a.filter===v)return a.filter(b,c);p(a,function(a,g,e){b.call(c,a,g,e)&&(d[d.length]=a)});return d};c.reject=function(a,b,c){var d=[];if(null==a)return d;p(a,function(a,g,e){b.call(c,a,g,e)||(d[d.length]=a)});return d};c.every=c.all=function(a,b,c){var d=!0;if(null==a)return d;if(s&&a.every===s)return a.every(b,c);p(a,function(a,g,f){if(!(d=d&&
b.call(c,a,g,f)))return e});return d};var F=c.some=c.any=function(a,b,d){b||(b=c.identity);var f=!1;if(null==a)return f;if(o&&a.some===o)return a.some(b,d);p(a,function(a,g,c){if(f||(f=b.call(d,a,g,c)))return e});return!!f};c.include=c.contains=function(a,b){return null==a?!1:z&&a.indexOf===z?-1!=a.indexOf(b):F(a,function(a){return a===b})};c.invoke=function(a,b){var d=j.call(arguments,2);return c.map(a,function(a){return(b.call?b||a:a[b]).apply(a,d)})};c.pluck=function(a,b){return c.map(a,function(a){return a[b]})};
...
p(a,function(a,g){0==g?b[0]=a:(c=Math.floor(Math.random()*(g+1)),b[g]=b[c],b[c]=a)});return b};c.sortBy=function(a,b,d){return c.pluck(c.map(a,function(a,g,c){return{value:a,criteria:b.call(d,a,g,c)}}).sort(function(a,g){var b=a.criteria,c=g.criteria;return b<c?-1:b>c?1:0}),"value")};c.groupBy=function(a,b){var d={},e=c.isFunction(b)?b:function(a){return a[b]};p(a,function(a,g){var b=e(a,g);(d[b]||(d[b]=[])).push(a)});return d};c.sortedIndex=function(a,b,d){d||(d=c.identity);for(var e=0,f=a.length;e<
f;){var h=e+f>>1;d(a[h])<d(b)?e=h+1:f=h}return e};c.toArray=function(a){return!a?[]:a.toArray?a.toArray():c.isArray(a)?j.call(a):c.isArguments(a)?j.call(a):c.values(a)};c.size=function(a){return c.toArray(a).length};c.first=c.head=function(a,b,c){return null!=b&&!c?j.call(a,0,b):a[0]};c.initial=function(a,b,c){return j.call(a,0,a.length-(null==b||c?1:b))};c.last=function(a,b,c){return null!=b&&!c?j.call(a,Math.max(a.length-b,0)):a[a.length-1]};c.rest=c.tail=function(a,b,c){return j.call(a,null==b||
c?1:b)};c.compact=function(a){return c.filter(a,function(a){return!!a})};c.flatten=function(a,b){return c.reduce(a,function(a,g){if(c.isArray(g))return a.concat(b?g:c.flatten(g));a[a.length]=g;return a},[])};c.without=function(a){return c.difference(a,j.call(arguments,1))};c.uniq=c.unique=function(a,b,d){var d=d?c.map(a,d):a,e=[];c.reduce(d,function(d,f,E){if(0==E||(!0===b?c.last(d)!=f:!c.include(d,f)))d[d.length]=f,e[e.length]=a[E];return d},[]);return e};c.union=function(){return c.uniq(c.flatten(arguments,
!0))};c.intersection=c.intersect=function(a){var b=j.call(arguments,1);return c.filter(c.uniq(a),function(a){return c.every(b,function(b){return 0<=c.indexOf(b,a)})})};c.difference=function(a){var b=c.flatten(j.call(arguments,1));return c.filter(a,function(a){return!c.include(b,a)})};c.zip=function(){for(var a=j.call(arguments),b=c.max(c.pluck(a,"length")),d=Array(b),e=0;e<b;e++)d[e]=c.pluck(a,""+e);return d};c.indexOf=function(a,b,d){if(null==a)return-1;var e;if(d)return d=c.sortedIndex(a,b),a[d]===
b?d:-1;if(z&&a.indexOf===z)return a.indexOf(b);for(d=0,e=a.length;d<e;d++)if(d in a&&a[d]===b)return d;return-1};c.lastIndexOf=function(a,b){if(null==a)return-1;if(D&&a.lastIndexOf===D)return a.lastIndexOf(b);for(var c=a.length;c--;)if(c in a&&a[c]===b)return c;return-1};c.range=function(a,b,c){1>=arguments.length&&(b=a||0,a=0);for(var c=arguments[2]||1,d=Math.max(Math.ceil((b-a)/c),0),e=0,f=Array(d);e<d;)f[e++]=a,a+=c;return f};var G=function(){};c.bind=function(a,b){var d,e;if(a.bind===B&&B)return B.apply(a,
j.call(arguments,1));if(!c.isFunction(a))throw new TypeError;e=j.call(arguments,2);return d=function(){if(!(this instanceof d))return a.apply(b,e.concat(j.call(arguments)));G.prototype=a.prototype;var c=new G,f=a.apply(c,e.concat(j.call(arguments)));return Object(f)===f?f:c}};c.bindAll=function(a){var b=j.call(arguments,1);0==b.length&&(b=c.functions(a));p(b,function(b){a[b]=c.bind(a[b],a)});return a};c.memoize=function(a,b){var d={};b||(b=c.identity);return function(){var c=b.apply(this,arguments);
return l.call(d,c)?d[c]:d[c]=a.apply(this,arguments)}};c.delay=function(a,b){var c=j.call(arguments,2);return setTimeout(function(){return a.apply(a,c)},b)};c.defer=function(a){return c.delay.apply(c,[a,1].concat(j.call(arguments,1)))};c.throttle=function(a,b){var d,e,f,h,j,k=c.debounce(function(){j=h=!1},b);return function(){d=this;e=arguments;f||(f=setTimeout(function(){f=null;j&&a.apply(d,e);k()},b));h?j=!0:a.apply(d,e);k();h=!0}};c.debounce=function(a,b){var c;return function(){var d=this,e=arguments;
...
Object(a))throw new TypeError("Invalid object");var b=[],c;for(c in a)l.call(a,c)&&(b[b.length]=c);return b};c.values=function(a){return c.map(a,c.identity)};c.functions=c.methods=function(a){var b=[],d;for(d in a)c.isFunction(a[d])&&b.push(d);return b.sort()};c.extend=function(a){p(j.call(arguments,1),function(b){for(var c in b)void 0!==b[c]&&(a[c]=b[c])});return a};c.defaults=function(a){p(j.call(arguments,1),function(b){for(var c in b)null==a[c]&&(a[c]=b[c])});return a};c.clone=function(a){return!c.isObject(a)?
...
"\\r").replace(/\n/g,"\\n").replace(/\t/g,"\\t")+"');}return __p.join('');",e=new Function("obj","_",d);return b?e(b,c):function(a){return e.call(this,a,c)}};var t=function(a){this._wrapped=a};c.prototype=t.prototype;var C=function(a,b){return b?c(a).chain():a},I=function(a,b){t.prototype[a]=function(){var a=j.call(arguments);u.call(a,this._wrapped);return C(b.apply(c,a),this._chain)}};c.mixin(c);p("pop,push,reverse,shift,sort,splice,unshift".split(","),function(a){var b=f[a];t.prototype[a]=function(){b.apply(this._wrapped,
arguments);return C(this._wrapped,this._chain)}});p(["concat","join","slice"],function(a){var b=f[a];t.prototype[a]=function(){return C(b.apply(this._wrapped,arguments),this._chain)}});t.prototype.chain=function(){this._chain=!0;return this};t.prototype.value=function(){return this._wrapped}}).call(this);
