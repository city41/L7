...
(function(){L7.AnimationFactory=function(a,b){this._owner=a;this._board=b;this._buildStack=[]};L7.AnimationFactory.prototype={_getBoard:function(){return this._board||this._owner.board},_addParentAnimation:function(a,b,c){b=new b(c);this._buildStack.push(b);a(this);this._buildStack.pop();0===this._buildStack.length?this._getBoard().addDaemon(b):this._buildStack.last.children.add(b);return b},_addAnimation:function(a,b){a.targets||(a.targets=this._owner.getAnimationTargets(a.filter));var c=new b(a);
0===this._buildStack.length?this._getBoard().addDaemon(c):this._buildStack.last.children.add(c);return c},disco:function(a){return this._addAnimation(a,L7.Disco)},shimmer:function(a){return this._addAnimation(a,L7.Shimmer)},setProperty:function(a){a.duration=0;a.from=a.to=a.value;return this.tween(a)},tween:function(a){return this._addAnimation(a,L7.Tween)},sequence:function(a){return this._addParentAnimation(a,L7.Repeat,1)},together:function(a){return this._addParentAnimation(a,L7.Together)},repeat:function(a,
b){return this._addParentAnimation(b,L7.Repeat,a)},wait:function(a){return this._addAnimation({duration:a},L7.Wait)},invoke:function(a){return this._addAnimation({func:a},L7.Invoke)}}})();
...
Math.easeInOutBounce=function(a,b,c,d){return a<d/2?0.5*Math.easeInBounce(2*a,0,c,d)+b:0.5*Math.easeOutBounce(2*a-d,0,c,d)+0.5*c+b};(function(){L7.Invoke=function(){_.extend(this,config);this.reset()};L7.Invoke.prototype={reset:function(){this.done=!1},update:function(){this.done||(this.func(),this.done=!0)}}})();
