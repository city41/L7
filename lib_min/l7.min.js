...
[],b=this.weights&&_.isNumber(this.weights[0])?this.weights[0]:1,c=this.weights&&_.isNumber(this.weights[1])?this.weights[1]:1,d=this.weights&&_.isNumber(this.weights[2])?this.weights[2]:1,e=this.alpha||1,f=this.noise||1,g=0,h,k,i;256>g;g++)h=~~(128+128*Math.sin(Math.PI*g/(32/f))),k=~~(128+128*Math.sin(Math.PI*g/(64/f))),i=~~(128+128*Math.sin(Math.PI*g/(128/f))),h=Math.min(255,h*b),k=Math.min(255,k*c),i=Math.min(255,i*d),a[g]=[h,k,i,e];return a},_determineDim:function(a,b){var c=Math.min.apply(null,
...
this.width*this.height),c=0,d=this.tileSize,e=this.borderWidth,f=0;f<this.height;++f)for(var g=0;g<this.width;++g){var h=g*(d+e)+e,k=f*(d+e)+e,i=d;b[c++]=h;b[c++]=k;b[c++]=0;b[c++]=h+i;b[c++]=k;b[c++]=0;b[c++]=h+i;b[c++]=k+i;b[c++]=0;b[c++]=h;b[c++]=k;b[c++]=0;b[c++]=h+i;b[c++]=k+i;b[c++]=0;b[c++]=h;b[c++]=k+i;b[c++]=0}a.bufferData(a.ARRAY_BUFFER,b,a.STATIC_DRAW);this.squareVertexPositionBuffer.itemSize=3;this.squareVertexPositionBuffer.numItems=b.length/3;this.colorBuffer=a.createBuffer();this.getTileColors(a)},
...
this.colorBuffer.itemSize,b.FLOAT,!1,0,0);b.drawArrays(b.TRIANGLES,0,this.squareVertexPositionBuffer.numItems)},render:function(a,b,c,d){var c=c+(this.offsetX||0),d=d+(this.offsetY||0),e=this.borderWidth,a=this.tileSize,f=d/(a+e)|0,g=-d%(a+e),h,k=Math.min(this._rows.length,Math.ceil((d+b.canvas.height)/(a+e))),i=c/(a+e)|0,l=-c%(a+e),m,r=Math.min(this._rows[0].length,Math.ceil((c+b.canvas.width)/(a+e))),o,j,q,p=[];for(h=f;h<k;++h)if(0<=h){q=this._rows[h];for(m=i;m<r;++m)if(0<=m&&(o=q[m],j=o.getColor()))n=
o.getScale(),_.isNumber(n)||(n=1),1!==n&&(p.push(o),j=o.getColor(!0),n=1),j&&(this.borderFill&&(b.fillStyle=this.borderFill,b.fillRect((m-i)*(a+e)+l,(h-f)*(a+e)+g,a+2*e,e),b.fillRect((m-i)*(a+e)+l,(h-f)*(a+e)+g+a+e,a+2*e,e),b.fillRect((m-i)*(a+e)+l,(h-f)*(a+e)+g,e,a+2*e),b.fillRect((m-i)*(a+e)+l+a+e,(h-f)*(a+e)+g,e,a+2*e)),b.fillStyle=L7.Color.toCssString(j),j=Math.round(a*n),n=a/2-j/2,b.fillRect((m-i)*(a+e)+e+n+l,(h-f)*(a+e)+e+n+g,j,j))}p.sort(function(a,c){return a.scale-c.scale});for(h=0;h<p.length;++h){o=
p[h];var n=o.getScale();if(j=o.getColor())b.fillStyle=j,j=Math.round(a*n),n=a/2-j/2,b.fillRect((o.x-i)*(a+e)+e+n+l,(o.y-f)*(a+e)+e+n+g,j,j)}for(h=0;h<this.freeActors.length;++h)if(e=this.freeActors[h],j=L7.Color.toCssString(e.color))b.fillStyle=j,b.fillRect(e.position.x-c,e.position.y-d,a,a)}}})();
...
if(this.isRgbString(c)){for(var d=c.indexOf("("),e=[],c=c.substring(d+1).split(","),d=0,f=c.length;d<f;++d)e.push(parseFloat(c[d]));3===e.length&&e.push(1);return e}},fromArrayToHex:function(a,b){for(var e="#",f=b&&b.includeAlpha&&4===a.length?4:3,g=0;g<f;++g){var h=a[g].toString(16);2>h.length&&(h="0"+h);e+=h}return e.toUpperCase()},composite:function(a){for(var b=this.toArray(arguments[0]).slice(0),e=1;e<arguments.length;++e){var f=b,g=this.toArray(arguments[e]),h=g[3],k=f[3],i=1-h,l=void 0,m=void 0;
for(l=0,m=f.length-1;l<m;++l)f[l]=Math.round(g[l]*h+f[l]*k*i);f[3]=(f[3]+g[3])/2}return b},fromFloats:function(a,b,e,f){return[Math.round(255*a),Math.round(255*b),Math.round(255*e),f]}};var b={aliceblue:"#F0F8FF",antiquewhite:"#FAEBD7",aqua:"#00FFFF",aquamarine:"#7FFFD4",azure:"#F0FFFF",beige:"#F5F5DC",bisque:"#FFE4C4",black:"#000000",blanchedalmond:"#FFEBCD",blue:"#0000FF",blueviolet:"#8A2BE2",brown:"#A52A2A",burlywood:"#DEB887",cadetblue:"#5F9EA0",chartreuse:"#7FFF00",chocolate:"#D2691E",coral:"#FF7F50",
