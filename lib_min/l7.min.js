...
i,t=Math.min(this._rows.length,Math.ceil((d+b.canvas.height)/(a+e))),l=(0>c?Math.ceil:Math.floor)(c/(a+e)),k=-c%(a+e),n,v=Math.min(this._rows[0].length,Math.ceil((c+b.canvas.width)/(a+e))),q,m,u,r=[];for(i=g;i<t;++i)if(0<=i){u=this._rows[i];for(n=l;n<v;++n)if(0<=n&&(q=u[n],m=q.getColor()))o=q.getScale(),_.isNumber(o)||(o=1),1!==o&&(r.push(q),m=q.getColor(!0),o=1),m&&(this.borderFill&&(b.fillStyle=this.borderFill,b.fillRect((n-l)*(a+e)+k,(i-g)*(a+e)+h,a+2*e,e),b.fillRect((n-l)*(a+e)+k,(i-g)*(a+e)+
...
if(this.isRgbString(c)){for(var d=c.indexOf("("),e=[],c=c.substring(d+1).split(","),d=0,g=c.length;d<g;++d)e.push(parseFloat(c[d]));3===e.length&&e.push(1);return e}},fromArrayToHex:function(a,b){for(var e="#",g=b&&b.includeAlpha&&4===a.length?4:3,h=0;h<g;++h){var i=a[h].toString(16);2>i.length&&(i="0"+i);e+=i}return e.toUpperCase()},composite:function(a){for(var b=this.toArray(arguments[0]).slice(0),e=1;e<arguments.length;++e){var g=b,h=this.toArray(arguments[e]),i=h[3],t=g[3],l=1-i,k=void 0,n=void 0;
for(k=0,n=g.length-1;k<n;++k)g[k]=Math.round(h[k]*i+g[k]*t*l);g[3]=(g[3]+h[3])/2}return b},fromFloats:function(a,b,e,g){return[Math.round(255*a),Math.round(255*b),Math.round(255*e),g]}};var b={aliceblue:"#F0F8FF",antiquewhite:"#FAEBD7",aqua:"#00FFFF",aquamarine:"#7FFFD4",azure:"#F0FFFF",beige:"#F5F5DC",bisque:"#FFE4C4",black:"#000000",blanchedalmond:"#FFEBCD",blue:"#0000FF",blueviolet:"#8A2BE2",brown:"#A52A2A",burlywood:"#DEB887",cadetblue:"#5F9EA0",chartreuse:"#7FFF00",chocolate:"#D2691E",coral:"#FF7F50",
...
(function(){function a(){return L7.rand(-1,1,!0)}var b=0;L7.ParticleSystem=function(a){_.extend(this,a);this._particles=[];this.id=b++;for(a=0;a<this.totalParticles;++a)this._particles.push({});this._particleCount=this._particleIndex=this._emitCounter=this._elapsed=0;this.active=this.active||!1};L7.ParticleSystem.prototype={onRemove:function(a){a.actorsOnTeam("particle-"+this.id).forEach(function(b){a.removeActor(b)})},_isFull:function(){return this._particleCount===this.totalParticles},_initParticle:function(c){c.rx=
this.position.x+this.posVar.x*a();c.ry=this.position.y+this.posVar.y*a();var b;b=this.angle+this.angleVar*a();b=(b||0)*Math.PI/180;b=L7.p(Math.cos(b),Math.sin(b));var e=this.speed+this.speedVar*a();b=b.multiply(e);c.dir=b;c.radialAccel=this.radialAccel+this.radialAccelVar*a();c.radialAccel&&(c.radialAccel=0);c.tangentialAccel=this.tangentialAccel+this.tangentialAccelVar*a();c.tangentialAccel||(c.tangentialAccel=0);b=this.life+this.lifeVar*a();c.life=Math.max(0,b);b=[this.startColor[0]+this.startColorVar[0]*
a(),this.startColor[1]+this.startColorVar[1]*a(),this.startColor[2]+this.startColorVar[2]*a(),this.startColor[3]+this.startColorVar[3]*a()];e=[this.endColor[0]*this.endColorVar[0]*a(),this.endColor[1]*this.endColorVar[1]*a(),this.endColor[2]*this.endColorVar[2]*a(),this.endColor[3]*this.endColorVar[3]*a()];c.color=b;c.deltaColor=[(e[0]-b[0])/c.life,(e[1]-b[1])/c.life,(e[2]-b[2])/c.life,(e[3]-b[3])/c.life];_.isUndefined(this.startSize)?(c.size=1,c.deltaSize=0):(b=this.startSize+this.startSizeVar*a(),
b=Math.max(0,b),c.size=b,_.isUndefined(this.endSize)?c.deltaSize=0:(e=this.endSize+this.endSizeVar*a(),c.deltaSize=(e-b)/c.life))},_addParticle:function(){if(this._isFull())return!1;this._initParticle(this._particles[this._particleCount]);++this._particleCount;return!0},update:function(a,b,e){if(this.active){a/=1E3;if(this.emissionRate){b=1/this.emissionRate;for(this._emitCounter+=a;!this._isFull()&&this._emitCounter>b;)this._addParticle(),this._emitCounter-=b}this._elapsed+=a;this.active=this._elapsed<
this.duration;for(this._particleIndex=0;this._particleIndex<this._particleCount;)this._updateParticle(this._particles[this._particleIndex],a,this._particleIndex);this._updateBoard(e)}},_updateParticle:function(a,b,e){if(0<a.life){var e=L7.p(),g=L7.p(),h=L7.p();0!==a.rx&&0!==a.ry&&(g=L7.p(a.rx,a.ry).normalize());h=g.clone();g.x*=a.radialAccel;g.y*=a.radialAccel;var i=h.x;h.x=-h.y;h.y=i;h.x*=a.tangentialAccel;h.y*=a.tangentialAccel;e.x=g.x+h.x+this.gravity.x;e.y=g.y+h.y+this.gravity.y;e.x*=b;e.y*=b;
a.dir.x+=e.x;a.dir.y+=e.y;e.x=a.dir.x*b;e.y=a.dir.y*b;a.rx+=e.x;a.ry+=e.y;a.x=Math.round(a.rx);a.y=Math.round(a.ry);a.color[0]+=a.deltaColor[0]*b;a.color[1]+=a.deltaColor[1]*b;a.color[2]+=a.deltaColor[2]*b;a.color[3]+=a.deltaColor[3]*b;a.size+=a.deltaSize*b;a.size=Math.max(0,a.size);a.life-=b;++this._particleIndex}else a=this._particles[e],this._particles[e]=this._particles[this._particleCount-1],this._particles[this._particleCount-1]=a,--this._particleCount},_updateBoard:function(a){a.actorsOnTeam("particle-"+
this.id).forEach(function(b){a.removeActor(b)});for(var b=0,e=0;e<this._particleCount;++e){var g=this._particles[e],h=a.tileAt(g.x,g.y);if(h){var i=h.inhabitants&&h.inhabitants.length&&h.inhabitants.last.owner;i?i.color=L7.Color.composite(i.color,g.color):a.addActor(new L7.Actor({position:h.position,color:g.color.slice(0),team:"particle-"+this.id,scale:g.size}))}else++b;b===this._particleCount&&console.log("all are off the board :-/")}}}})();
...
c.source&&b.global==c.global&&b.multiline==c.multiline&&b.ignoreCase==c.ignoreCase}if("object"!=typeof b||"object"!=typeof c)return!1;for(var g=d.length;g--;)if(d[g]==b)return!0;d.push(b);var g=0,h=!0;if("[object Array]"==e){if(g=b.length,h=g==c.length)for(;g--&&(h=g in b==g in c&&a(b[g],c[g],d)););}else{if("constructor"in b!="constructor"in c||b.constructor!=c.constructor)return!1;for(var i in b)if(k.call(b,i)&&(g++,!(h=k.call(c,i)&&a(b[i],c[i],d))))break;if(h){for(i in c)if(k.call(c,i)&&!g--)break;
h=!g}}d.pop();return h}var b=this,c=b._,d={},e=Array.prototype,g=Object.prototype,h=e.slice,i=e.concat,t=e.unshift,l=g.toString,k=g.hasOwnProperty,n=e.forEach,v=e.map,q=e.reduce,m=e.reduceRight,u=e.filter,r=e.every,o=e.some,w=e.indexOf,B=e.lastIndexOf,g=Array.isArray,E=Object.keys,z=Function.prototype.bind,f=function(a){return new s(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=f),exports._=f):"function"===typeof define&&define.amd?define("underscore",
function(){return f}):b._=f;f.VERSION="1.2.3";var p=f.each=f.forEach=function(a,b,c){if(null!=a)if(n&&a.forEach===n)a.forEach(b,c);else if(a.length===+a.length)for(var e=0,f=a.length;e<f&&!(e in a&&b.call(c,a[e],e,a)===d);e++);else for(e in a)if(k.call(a,e)&&b.call(c,a[e],e,a)===d)break};f.map=function(a,b,c){var d=[];if(null==a)return d;if(v&&a.map===v)return a.map(b,c);p(a,function(a,j,e){d[d.length]=b.call(c,a,j,e)});return d};f.reduce=f.foldl=f.inject=function(a,b,c,d){var e=2<arguments.length;
...
function(a,b,c){var d;C(a,function(a,j,e){if(b.call(c,a,j,e))return d=a,!0});return d};f.filter=f.select=function(a,b,c){var d=[];if(null==a)return d;if(u&&a.filter===u)return a.filter(b,c);p(a,function(a,j,e){b.call(c,a,j,e)&&(d[d.length]=a)});return d};f.reject=function(a,b,c){var d=[];if(null==a)return d;p(a,function(a,j,e){b.call(c,a,j,e)||(d[d.length]=a)});return d};f.every=f.all=function(a,b,c){var e=!0;if(null==a)return e;if(r&&a.every===r)return a.every(b,c);p(a,function(a,j,f){if(!(e=e&&
b.call(c,a,j,f)))return d});return e};var C=f.some=f.any=function(a,b,c){b||(b=f.identity);var e=!1;if(null==a)return e;if(o&&a.some===o)return a.some(b,c);p(a,function(a,j,f){if(e||(e=b.call(c,a,j,f)))return d});return!!e};f.include=f.contains=function(a,b){return null==a?!1:w&&a.indexOf===w?-1!=a.indexOf(b):C(a,function(a){return a===b})};f.invoke=function(a,b){var c=h.call(arguments,2);return f.map(a,function(a){return(b.call?b||a:a[b]).apply(a,c)})};f.pluck=function(a,b){return f.map(a,function(a){return a[b]})};
...
b?c:-1;if(w&&a.indexOf===w)return a.indexOf(b);for(c=0,d=a.length;c<d;c++)if(c in a&&a[c]===b)return c;return-1};f.lastIndexOf=function(a,b){if(null==a)return-1;if(B&&a.lastIndexOf===B)return a.lastIndexOf(b);for(var c=a.length;c--;)if(c in a&&a[c]===b)return c;return-1};f.range=function(a,b,c){1>=arguments.length&&(b=a||0,a=0);for(var c=arguments[2]||1,d=Math.max(Math.ceil((b-a)/c),0),e=0,f=Array(d);e<d;)f[e++]=a,a+=c;return f};var D=function(){};f.bind=function(a,b){var c,d;if(a.bind===z&&z)return z.apply(a,
h.call(arguments,1));if(!f.isFunction(a))throw new TypeError;d=h.call(arguments,2);return c=function(){if(!(this instanceof c))return a.apply(b,d.concat(h.call(arguments)));D.prototype=a.prototype;var e=new D,f=a.apply(e,d.concat(h.call(arguments)));return Object(f)===f?f:e}};f.bindAll=function(a){var b=h.call(arguments,1);0==b.length&&(b=f.functions(a));p(b,function(b){a[b]=f.bind(a[b],a)});return a};f.memoize=function(a,b){var c={};b||(b=f.identity);return function(){var d=b.apply(this,arguments);
...
"\\r").replace(/\n/g,"\\n").replace(/\t/g,"\\t")+"');}return __p.join('');",d=new Function("obj","_",c);return b?d(b,f):function(a){return d.call(this,a,f)}};var s=function(a){this._wrapped=a};f.prototype=s.prototype;var A=function(a,b){return b?f(a).chain():a},F=function(a,b){s.prototype[a]=function(){var a=h.call(arguments);t.call(a,this._wrapped);return A(b.apply(f,a),this._chain)}};f.mixin(f);p("pop,push,reverse,shift,sort,splice,unshift".split(","),function(a){var b=e[a];s.prototype[a]=function(){b.apply(this._wrapped,
arguments);return A(this._wrapped,this._chain)}});p(["concat","join","slice"],function(a){var b=e[a];s.prototype[a]=function(){return A(b.apply(this._wrapped,arguments),this._chain)}});s.prototype.chain=function(){this._chain=!0;return this};s.prototype.value=function(){return this._wrapped}}).call(this);
