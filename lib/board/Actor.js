(function() {
	...
	L7.Actor.prototype = {
		_createPiecesFromImagehorizontal: function() {
			...
			function getRelPos(x, i) {
				i = i / 4;
				var rx = i % me.framesConfig.width;
			...
			for (var x = 0; x < this.framesConfig.src.width; x += this.framesConfig.width) {
				var imageData = context.getImageData(x, 0, this.framesConfig.width, this.framesConfig.height);
				var pieceSource = [];
