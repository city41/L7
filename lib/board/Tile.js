(function() {
	...
	L7.Tile.prototype = {
		...
		getColor: function() {
			...
			var topInhab = this.inhabitants[0];

			if(L7.Color.isOpaque(topInhab.color)) {
				return topInhab.color;
			}

			var composite = L7.Color.composite(this.color, topInhab.color);

			var color = L7.Color.toCssString(composite);
			return color;
		},
