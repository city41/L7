(function() {
	L7.Board = function(config) {
		...
		this.viewportWidth = this.viewportWidth || this.width;
		this.viewportHeight = this.viewportHeight || this.height;
		this.viewportAnchor = this.viewportAnchor || L7.p(0, 0);
	};

	L7.Board.prototype = {
		scrollY: function(amount) {
			this.viewportAnchor = this.viewportAnchor.add(L7.p(0, amount));
		},
